<script lang="ts">
   let { band1, band2, band3, band4 } = $props();
  ...
  <g transform="translate(-525.18201,-200.4222)">
    <g>
      ...
      <path
         ...
         style:fill={band1}
         style:stroke={darken(band1, 0.50)} />
      <path
         ...
         style="stroke-width:1"
         style:fill={band2}
         style:stroke={darken(band2, 0.50)} />
      <path
         d="m 1014.1875,226.5472 v 231.625 h 68.6875 v -231.625 z"
         style="stroke-width:1"
         style:fill={band3}
         style:stroke={darken(band3, 0.50)} />
      {#if false}
         <path
      ...
      <path
         ...
         style="stroke-width:1"
         style:fill={band4}
         style:stroke={darken(band4, 0.50)} />
    </g>
  </g>
</svg>